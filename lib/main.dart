    ...
    child: BackdropFilter(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border(
            bottom: BorderSide(
              color: cs.outlineVariant.withValues(alpha: 0.04),
            ),
          ),
        ),
      ),
...
enum _AppMenuAction { refresh, manageFolders, toggleTheme, about, quit }
      ...
      UserPlaylistPage(
        ...
        onUpdateSongIds: (id, newSongIds) async {
          ...
          setState(() {
            ...
            _userPlaylists = List<UserPlaylist>.from(
              _userPlaylists,
                        ...
                        children: [
                          KeyedSubtree(
                            ...
                            child: LibraryTab(
                              ...
                              cachedMostPlayed: _cachedMostPlayed,
                              cachedRecentlyPlayed: _cachedRecentlyPlayed,
                              cachedRecentlyAdded: _cachedRecentlyAdded,
                              controller: _controller,
                              onExitSelectionMode: _exitSelectionMode,
                              onAddSongsToPlaylist: _addSongsToPlaylistFlow,
                              onToggleSelectedSongId: _toggleSelectedSongId,
                              onEnterSelectionMode: _enterSelectionMode,
                              onOpenAlbumPageFromSong: _openAlbumPageFromSong,
                              onOpenArtistPage: _openArtistPageFromSong,
                              onShowSongOptions: _showSongOptions,
                              onShowInlineDetail: _showInlineDetail,
                              onRefreshLibrary: _recomputeAllData,
                            ),
                          ),
                          KeyedSubtree(
                            key: const PageStorageKey<String>('tab_album_artists'),
                            child: AlbumArtistsTab(
                              cachedAlbumArtists: _cachedAlbumArtists,
                              albumArtistsSort: _albumArtistsSort,
                              onSortChanged: (mode) {
                                setState(() {
                              ...
                              onOpenArtistPageByName: _openArtistPageByName,
                            ),
                          ),
                          KeyedSubtree(
                          ...
                          KeyedSubtree(
                            ...
                            child: PlaylistsTab(
                              ...
                              cachedUserPlaylistTrackCounts: _cachedUserPlaylistTrackCounts,
                              onShowInlineDetail: _showInlineDetail,
                              ...
                              onCloseInlineDetail: _closeInlineDetail,
                              isSelectionMode: _isSelectionMode,
                              onExitSelectionMode: _exitSelectionMode,
                              nowPlayingRouteActive: _nowPlayingRouteActive,
                              onPlaylistCreated: _createNewPlaylist,
                              onOpenUserPlaylistPage: (pl) => _openUserPlaylistPage(pl),
                              onImportPlaylist: _importM3uPlaylistFlow,
                              onReorderUserPlaylists: _reorderUserPlaylists,
                            ),
                          ),
                        ],
                      ),
